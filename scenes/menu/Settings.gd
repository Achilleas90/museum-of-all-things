...
@onready var _vbox = $ContentCard/ScrollContainer/MarginContainer/VBoxContainer/MarginContainer
@onready var _tab_bar = $ContentCard/ScrollContainer/MarginContainer/VBoxContainer/TabBar
